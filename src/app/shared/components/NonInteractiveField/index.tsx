...
const teamSheetLayoutData = {
  field: [
    ...
    { teamSheetLayoutId: '9', style: { top: '310px', left: '140px' } },
    { teamSheetLayoutId: '10', style: { top: '310px', left: '360px' } },
    { teamSheetLayoutId: '11', style: { top: '410px', left: '140px' } },
    { teamSheetLayoutId: '12', style: { top: '360px', left: '250px' } },
    { teamSheetLayoutId: '13', style: { top: '360px', left: '470px' } },
    { teamSheetLayoutId: '14', style: { top: '410px', left: '580px' } },
